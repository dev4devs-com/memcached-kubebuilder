...
import (
	...
	memcachedv1 "memcached-kubebuilder/api/v1"
...
// +kubebuilder:rbac:groups=memcached.dev4devs.com,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=memcached.dev4devs.com,resources=memcacheds/status,verbs=get;update;patch
